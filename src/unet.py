...
class Unet(nn.Module):
    ...
    def forward(self, x, time, y=None):
        ...
        return self.forward_shared(h, t, x)

    def forward_shared(self, h, t, x):
        # downsample
...
class UnetConditional(Unet):
    ...
    def __init__(self, dim, init_dim=None, out_dim=None, dim_mults=(1, 2, 4, 8), channels=3, with_time_emb=True,
                 resnet_block_groups=8, use_convnext=True, convnext_mult=2, num_classes=None):
        super().__init__(dim, init_dim, out_dim, dim_mults, channels, with_time_emb, resnet_block_groups, use_convnext,
                         convnext_mult)
